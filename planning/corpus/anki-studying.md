...
- [Decks](https://docs.ankiweb.net/studying.html#decks)
- [Study Overview](https://docs.ankiweb.net/studying.html#study-overview)
- [Questions](https://docs.ankiweb.net/studying.html#questions)
...
- [Editing and More](https://docs.ankiweb.net/studying.html#editing-and-more)
- [Display Order](https://docs.ankiweb.net/studying.html#display-order)
- [Siblings and Burying](https://docs.ankiweb.net/studying.html#siblings-and-burying)
- [Keyboard Shortcuts](https://docs.ankiweb.net/studying.html#keyboard-shortcuts)
- [Falling Behind](https://docs.ankiweb.net/studying.html#falling-behind)
...
On the decks screen, your decks and subdecks will be displayed in a list. [New, Learn, and Due (To Review)](https://docs.ankiweb.net/getting-started.html#card-states)
cards for that day will be also displayed here.

![](https://docs.ankiweb.net/media/decks_screen.png)
...
delete the deck, change its [options](https://docs.ankiweb.net/deck-options.html), or [export](https://docs.ankiweb.net/exporting.html) it.
...
![](https://docs.ankiweb.net/media/study_overview.png)

The cards are split into [three types](https://docs.ankiweb.net/getting-started.html#card-states): New, Learning, and To Review.
If you have [Bury siblings](https://docs.ankiweb.net/studying.html#siblings-and-burying) activated in your deck options, you
may see how many cards will be buried in grey:

![](https://docs.ankiweb.net/media/study_overview_buried_cards.png)
...
press the `Space`. The answer will then be shown. It’s okay if it takes
...
Each answer button shows the next time a card will be reviewed again if you select that button. To learn about the settings that control the next review intervals, see the topics [Learning Steps](https://docs.ankiweb.net/deck-options.html#learning-steps), [Lapses](https://docs.ankiweb.net/deck-options.html#lapses), [FSRS](https://docs.ankiweb.net/deck-options.html#fsrs) and [Advanced](https://docs.ankiweb.net/deck-options.html#advanced) in the Deck Options section.
...
screen works very similarly to the [add notes](https://docs.ankiweb.net/editing.html) screen.
...
- [**Flag Card**](https://docs.ankiweb.net/editing.html#using-flags): Adds a colored marker to the card, or toggles it off. Flags will appear during
...
from the [browser](https://docs.ankiweb.net/browsing.html).
...
button on the [deck overview](https://docs.ankiweb.net/studying.html#study-overview) screen.) This is useful if
you cannot answer the card at the moment or you want to come back to it
another time. Burying can also [happen automatically](https://docs.ankiweb.net/studying.html#siblings-and-burying) for
cards of the same note.

- **Reset card**: Moves the current card to [the end of the new queue](https://docs.ankiweb.net/browsing.html#cards).
...
- **Set Due Date**: Puts cards in the review queue, and [makes them due on a certain date.](https://docs.ankiweb.net/browsing.html#cards)
...
- **Options**: Edit the [options](https://docs.ankiweb.net/deck-options.html) for the current deck.

- **Card Info**: Displays [statistical information](https://docs.ankiweb.net/stats.html#card-info) about the card.

- **Previous Card Info**: Displays [statistical information](https://docs.ankiweb.net/stats.html#card-info) about the previous card.

- [**Mark Note**](https://docs.ankiweb.net/editing.html#the-marked-tag): Adds a “marked” tag to the current note, so it can be easily found in the
...
- **Create Copy**: Opens a [duplicate](https://docs.ankiweb.net/browsing.html#finding-duplicates) of the current
...
To control the order cards appear in, see [Display Order](https://docs.ankiweb.net/deck-options.html#display-order). For more fine-grained ordering of new cards, you
can change the order in the [browser](https://docs.ankiweb.net/browsing.html).

Recall from [the basics](https://docs.ankiweb.net/getting-started.html) that Anki can create more than one
...
visible at the bottom of the [deck overview](https://docs.ankiweb.net/studying.html#study-overview) screen. Anki
will bury siblings even if the siblings are not in the same deck (for
instance, if you use the [deck override](https://docs.ankiweb.net/templates/intro.html) feature).

You can enable burying from the [deck options](https://docs.ankiweb.net/deck-options.html) screen -
