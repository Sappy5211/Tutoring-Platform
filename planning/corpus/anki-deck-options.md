...
a [one-way sync](https://docs.ankiweb.net/syncing.html#conflicts).
...
- The [display order](https://docs.ankiweb.net/deck-options.html#display-order) options are taken from the
...
[learning cards](https://docs.ankiweb.net/getting-started.html#card-states). Once a card
...
early by default. To turn this off or change the amount of time to look ahead, see [Preferences](https://docs.ankiweb.net/preferences.html).

Anki treats small steps and steps that [cross a day boundary](https://docs.ankiweb.net/preferences.html#review) differently.
...
from [earlier in this section](https://docs.ankiweb.net/deck-options.html#learning-steps).
...
Control the way Anki handles leeches. For details, see the [leeches](https://docs.ankiweb.net/leeches.html)
section.
...
the question side is played when you use replay action on the answer side. Note that, Anki [does not automatically play](https://docs.ankiweb.net/templates/fields.html#special-fields) audio from the `{{FrontSide}}` field. This option does not influence the behaviour of automatic play.
...
![graph showing an exponential increase in workload as desired retention nears one.](https://docs.ankiweb.net/media/FSRS_retention.png)
...
[this section](https://docs.ankiweb.net/deck-options.html#the-simulator).
...
decks using the current preset. You can optionally [adjust the search](https://docs.ankiweb.net/searching.html)
...
(which then becomes 1 day after the [minimum interval](https://docs.ankiweb.net/deck-options.html#minimum-interval) is
applied).
