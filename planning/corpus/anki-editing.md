...
[Print this book](https://docs.ankiweb.net/print.html "Print this book")[Git repository](https://github.com/ankitects/anki-manual/ "Git repository")

- [Adding Cards and Notes](https://docs.ankiweb.net/editing.html#adding-cards-and-notes)
  - [Duplicate Check](https://docs.ankiweb.net/editing.html#duplicate-check)
  - [Effective Learning](https://docs.ankiweb.net/editing.html#effective-learning)
- [Adding a Note Type](https://docs.ankiweb.net/editing.html#adding-a-note-type)
- [Customizing Fields](https://docs.ankiweb.net/editing.html#customizing-fields)
- [Changing Deck / Note Type](https://docs.ankiweb.net/editing.html#changing-deck--note-type)
- [Organizing Content](https://docs.ankiweb.net/editing.html#organizing-content)
  - [Using Decks Appropriately](https://docs.ankiweb.net/editing.html#using-decks-appropriately)
  - [Using Tags](https://docs.ankiweb.net/editing.html#using-tags)
  - [Using Flags](https://docs.ankiweb.net/editing.html#using-flags)
  - [The “Marked” Tag](https://docs.ankiweb.net/editing.html#the-marked-tag)
  - [Using Fields](https://docs.ankiweb.net/editing.html#using-fields)
  - [Custom Study and Filtered Decks](https://docs.ankiweb.net/editing.html#custom-study-and-filtered-decks)
- [Editing Features](https://docs.ankiweb.net/editing.html#editing-features)
- [Cloze Deletion](https://docs.ankiweb.net/editing.html#cloze-deletion)
- [Image Occlusion](https://docs.ankiweb.net/editing.html#image-occlusion)
  - [Adding an image](https://docs.ankiweb.net/editing.html#adding-an-image)
  - [Adding IO cards](https://docs.ankiweb.net/editing.html#adding-io-cards)
- [Editing IO notes](https://docs.ankiweb.net/editing.html#editing-io-notes)
- [Inputting Non-Latin Characters and Accents](https://docs.ankiweb.net/editing.html#inputting-non-latin-characters-and-accents)
  - [Adding international keyboard layouts](https://docs.ankiweb.net/editing.html#adding-international-keyboard-layouts)
  - [Adding keyboard layouts for specific languages](https://docs.ankiweb.net/editing.html#adding-keyboard-layouts-for-specific-languages)
  - [Right-to-left Languages](https://docs.ankiweb.net/editing.html#right-to-left-languages)
  - [Limitations](https://docs.ankiweb.net/editing.html#limitations)
- [Unicode Normalization](https://docs.ankiweb.net/editing.html#unicode-normalization)

Recall from the [basics](https://docs.ankiweb.net/getting-started.html) that in Anki we add notes rather than
cards, and Anki creates cards for us. Click **Add** in the [main window](https://docs.ankiweb.net/studying.html#decks),
and the Add Notes window will appear.

![Add Screen](https://docs.ankiweb.net/media/add_screen.png)

The top left of the window shows us the current [note type](https://docs.ankiweb.net/getting-started.html#note-types). If it does
...
The top right of the window shows us the [deck](https://docs.ankiweb.net/getting-started.html#decks) cards will be added to. If
...
“Front” and “Back”. Front and Back are called [fields](https://docs.ankiweb.net/getting-started.html#notes--fields), and you can add,
...
card in the [browser](https://docs.ankiweb.net/browsing.html).

For more information on the buttons between the note type and the
fields, see the [editor](https://docs.ankiweb.net/editing.html) section.
...
![Fields](https://docs.ankiweb.net/media/fields.png)
...
names, as they are [special fields](https://docs.ankiweb.net/templates/fields.html#special-fields) and will not work
properly.
...
reviewing; for that, see [templates](https://docs.ankiweb.net/templates/intro.html).
...
[templates](https://docs.ankiweb.net/templates/intro.html) section. If you have enabled the “type in the
...
when typing the answer, see the [checking your answer](https://docs.ankiweb.net/templates/fields.html#checking-your-answer) section.)
...
[template](https://docs.ankiweb.net/templates/styling.html#text-direction).
...
The animation can be disabled in the [preferences.](https://docs.ankiweb.net/preferences.html)

- **Exclude from unqualified searches (slower)** can be used if you want
the content of a certain field not to appear in unqualified [(not limited to a specific field)](https://docs.ankiweb.net/searching.html#limiting-to-a-field)
searches.
...
[Decks](https://docs.ankiweb.net/getting-started.html#decks) are designed to divide your content up into
...
decks in most cases. You can also organize tags in trees [in the same way as you can do for decks](https://docs.ankiweb.net/getting-started.html#decks).
...
[search](https://docs.ankiweb.net/searching.html#tags-decks-cards-and-notes) for all verbs, or all
food-related vocabulary, or all verbs that are related to food.

You can add tags from the Edit window and from the [Browser](https://docs.ankiweb.net/browsing.html), and you can also add,
delete, rename, or organize tags there. Note that
tags work at [note](https://docs.ankiweb.net/getting-started.html#notes--fields) level, which means that when you tag a card that has siblings,
...
is that flags work at [card](https://docs.ankiweb.net/getting-started.html#cards) level, so flagging a card that has siblings
won’t have any effect on the card’s siblings.

You can flag / unflag cards directly while in review mode (by pressing
`Ctrl` + `1-7` on Windows or `Cmd` + `1-7` on Mac)
and from the [Browser.](https://docs.ankiweb.net/browsing.html)
...
versions; most users will want to use [flags](https://docs.ankiweb.net/editing.html#using-flags) instead.
...
Using [custom study and filtered deck](https://docs.ankiweb.net/filtered-decks.html) you can create
...
The editor is shown when [adding notes](https://docs.ankiweb.net/editing.html), [editing a note](https://docs.ankiweb.net/studying.html#editing-and-more) during reviews, or [browsing](https://docs.ankiweb.net/browsing.html).

![Editor icons](https://docs.ankiweb.net/media/editor_icons.png)

On the top left are two buttons, which open the [fields](https://docs.ankiweb.net/editing.html#customizing-fields) and
[cards](https://docs.ankiweb.net/templates/intro.html) windows.
...
chemical compounds like H2O or simple mathematical equations like
x2. Then, there are two buttons to allow you to change text colour.
...
about media, see the [media](https://docs.ankiweb.net/media.html) section.
...
[LaTeX](https://docs.ankiweb.net/math.html) to your notes.

The \[…​\] buttons are visible when a cloze note type is selected.
![Cloze icons](https://docs.ankiweb.net/media/cloze_icons.png)

The `</>` button allows editing the underlying HTML of a field.
![HTML icon](https://docs.ankiweb.net/media/html_icon.png)
...
![Pin icon](https://docs.ankiweb.net/media/Pin_icon.png)
...
correctly, see the section on [typing answers](https://docs.ankiweb.net/templates/fields.html#checking-your-answer).
...
field to your cloze, add it to the [template](https://docs.ankiweb.net/templates/intro.html), and then when
...
![Image Occlusion](https://docs.ankiweb.net/media/io.jpg)
...
![Image Occlusion Modes](https://docs.ankiweb.net/media/io_modes.jpg)
...
and typing characters by holding down the `Alt` key and typing a
...
If you want character variants preserved, the following in the [debug console](https://docs.ankiweb.net/misc.html)
