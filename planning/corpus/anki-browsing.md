...
- [Table Modes](https://docs.ankiweb.net/browsing.html#table-modes)
- [Sidebar](https://docs.ankiweb.net/browsing.html#sidebar)
  - [Search Tool](https://docs.ankiweb.net/browsing.html#search-tool)
  - [Selection Tool](https://docs.ankiweb.net/browsing.html#selection-tool)
  - [Saved Searches](https://docs.ankiweb.net/browsing.html#saved-searches)
  - [Editing Items](https://docs.ankiweb.net/browsing.html#editing-items)
  - [Finding Items](https://docs.ankiweb.net/browsing.html#finding-items)
- [Search Box](https://docs.ankiweb.net/browsing.html#search-box)
- [Card/Note Table](https://docs.ankiweb.net/browsing.html#cardnote-table)
  - [Rows](https://docs.ankiweb.net/browsing.html#rows)
  - [Columns](https://docs.ankiweb.net/browsing.html#columns)
- [Editing Area](https://docs.ankiweb.net/browsing.html#editing-area)
- [Menus and Actions](https://docs.ankiweb.net/browsing.html#menus-and-actions)
  - [Edit](https://docs.ankiweb.net/browsing.html#edit)
  - [Notes](https://docs.ankiweb.net/browsing.html#notes)
  - [Cards](https://docs.ankiweb.net/browsing.html#cards)
  - [Go](https://docs.ankiweb.net/browsing.html#go)
- [Find and Replace](https://docs.ankiweb.net/browsing.html#find-and-replace)
- [Finding Duplicates](https://docs.ankiweb.net/browsing.html#finding-duplicates)
...
`B`. It is comprised of three sections: the _sidebar_ on the
...
![Table Modes](https://docs.ankiweb.net/media/browser_table_modes.png)
...
of the search area, or pressing `Ctrl` + `Alt` + `T` or
`Cmd` + `Opt` + `T`. The switch also indicates if **C** ards
...
![Search Tool](https://docs.ankiweb.net/media/browser_search_tool.png)

With this tool, the sidebar behaves as in previous versions: Clicking on an item
will search for it.

You can hold down `Ctrl` ( `Command` on Mac) while clicking in
...
do _not_ have a certain tag. `Alt`/ `Option` can be combined with
...
![Selection Tool](https://docs.ankiweb.net/media/browser_selection_tool2.png)

The Selection tool allows for selecting multiple items at the same time by holding down `Ctrl`
or `Shift` while clicking. It also enables drag-and-drop to reorder decks and
tags.
...
can be combined with keyboard modifiers as described in [Search Tool](https://docs.ankiweb.net/browsing.html#search-tool)
...
from the right-click menu, or by using a shortcut key ( `Del` and
`F2` on Windows). Deletion even works for multiple items at once
(see [Selection Tool](https://docs.ankiweb.net/browsing.html#selection-tool)).
...
see [Searching](https://docs.ankiweb.net/searching.html).
...
For more information about marked notes and suspended cards, see [Editing and More](https://docs.ankiweb.net/studying.html#editing-and-more).
...
All columns are available for both [Cards and Notes mode](https://docs.ankiweb.net/browsing.html#table-modes)
...
| --- | --- | --- |
| Answer | The back side of the card in one line with the question stripped. You can also choose a [custom format](https://docs.ankiweb.net/templates/styling.html#browser-appearance) in the card type editor instead. | The same as in Cards mode, only for the first card of the note. |
...
| Question | The front side of the card in one line. You can also choose a [custom format](https://docs.ankiweb.net/templates/styling.html#browser-appearance) in the card type editor instead. | The same as in Cards mode, only for the first card of the note. |
...
more information about cards and notes, see [Getting Started](https://docs.ankiweb.net/getting-started.html).
For more information on formatting buttons, see [Editing](https://docs.ankiweb.net/editing.html).
...
| Create Filtered Deck | Show the [filtered deck](https://docs.ankiweb.net/filtered-decks.html#creating-manually) dialog and set the current browser search as a filter. Use `Alt` / `Option` to set the second filter instead. |
...
| Name | Action |
| --- | --- |
| Add Notes | Open the [Add](https://docs.ankiweb.net/editing.html#adding-cards-and-notes) dialog. |
| Create Copy | Open a [duplicate](https://docs.ankiweb.net/browsing.html#finding-duplicates) of the current note in the [editor](https://docs.ankiweb.net/editing.html#adding-cards-and-notes), which can be slightly modified to easily obtain variations of your cards. By default, the duplicate card will be created in the same deck as the original. |
| Export Notes | Open the [Export](https://docs.ankiweb.net/exporting.html) dialog. |
...
| Find Duplicates | Open the [Duplicates](https://docs.ankiweb.net/browsing.html#finding-duplicates) dialog. |
| Find and Replace | Open the [Find and Replace](https://docs.ankiweb.net/browsing.html#find-and-replace) dialog. |
| Manage Note Types | Open the [Note Types](https://docs.ankiweb.net/editing.html#adding-a-note-type) dialog. |
| Delete | Delete all selected notes and their cards. It is not possible to remove individual cards, as individual cards are controlled by the [templates](https://docs.ankiweb.net/templates/intro.html). |
...
| Info | Show various information about the current card, including its review history. For more information, see [Card Info](https://docs.ankiweb.net/stats.html#card-info). |
...
![Find and Replace dialog](https://docs.ankiweb.net/media/find_and_replace.png)
...
For more information, see [Searching](https://docs.ankiweb.net/searching.html).
