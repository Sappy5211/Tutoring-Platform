...
- [Installing & Upgrading](https://docs.ankiweb.net/getting-started.html#installing--upgrading)
- [Videos](https://docs.ankiweb.net/getting-started.html#videos)
- [Key Concepts](https://docs.ankiweb.net/getting-started.html#key-concepts)
  - [Cards](https://docs.ankiweb.net/getting-started.html#cards)
  ...
  - [Notes & Fields](https://docs.ankiweb.net/getting-started.html#notes--fields)
  - [Card Types](https://docs.ankiweb.net/getting-started.html#card-types)
  - [Note Types](https://docs.ankiweb.net/getting-started.html#note-types)
  - [Collection](https://docs.ankiweb.net/getting-started.html#collection)
- [Shared Decks](https://docs.ankiweb.net/getting-started.html#shared-decks)
...
this, see the [using decks appropriately](https://docs.ankiweb.net/editing.html#using-decks-appropriately) section.

For information on how the order of decks affects the order cards are studied in,
see the [display order](https://docs.ankiweb.net/studying.html#display-order) section.
...
[Customizing Fields](https://docs.ankiweb.net/editing.html#customizing-fields) section.
...
editing notes. For more information on card types, see the [Cards and Templates](https://docs.ankiweb.net/templates/intro.html) section.
...
that field, a reversed card (back→front) will also be created. For details, see the [Cards and Templates](https://docs.ankiweb.net/templates/intro.html) section.
...
[Checking Your Answer](https://docs.ankiweb.net/templates/fields.html#checking-your-answer) section.
...
moon in 1969”). For details, see the [cloze deletion](https://docs.ankiweb.net/editing.html#cloze-deletion) section.
...
such as anatomy and geography. For details, see the [Image Occlusion](https://docs.ankiweb.net/editing.html#image-occlusion)
...
[change the note type of notes](https://docs.ankiweb.net/browsing.html#notes) after you’ve already created them.
...
desktop app, AnkiMobile, or AnkiDroid, then [synchronize](https://docs.ankiweb.net/syncing.html) to upload the decks to AnkiWeb.
