...
- [Card Info](https://docs.ankiweb.net/stats.html#card-info)
- [Statistics](https://docs.ankiweb.net/stats.html#statistics)
- [Selecting Decks / Collection](https://docs.ankiweb.net/stats.html#selecting-decks--collection)
  - [Deck](https://docs.ankiweb.net/stats.html#deck)
  - [Collection](https://docs.ankiweb.net/stats.html#collection)
  - [History](https://docs.ankiweb.net/stats.html#history)
  - [More](https://docs.ankiweb.net/stats.html#more)
- [Today](https://docs.ankiweb.net/stats.html#today)
  - [Again Count](https://docs.ankiweb.net/stats.html#again-count)
  - [Learn, Review, Relearn, Filtered](https://docs.ankiweb.net/stats.html#learn-review-relearn-filtered)
- [The Graphs](https://docs.ankiweb.net/stats.html#the-graphs)
  - [Future Due](https://docs.ankiweb.net/stats.html#future-due)
  - [Calendar](https://docs.ankiweb.net/stats.html#calendar)
  - [Reviews](https://docs.ankiweb.net/stats.html#reviews)
  - [Card Counts](https://docs.ankiweb.net/stats.html#card-counts)
  - [Review Time](https://docs.ankiweb.net/stats.html#review-time)
  - [Review Intervals](https://docs.ankiweb.net/stats.html#review-intervals)
  - [Card Ease](https://docs.ankiweb.net/stats.html#card-ease)
  - [Card Stability](https://docs.ankiweb.net/stats.html#card-stability)
  - [Card Difficulty](https://docs.ankiweb.net/stats.html#card-difficulty)
  - [Card Retrievability](https://docs.ankiweb.net/stats.html#card-retrievability)
  - [Hourly Breakdown](https://docs.ankiweb.net/stats.html#hourly-breakdown)
  - [Answer Buttons](https://docs.ankiweb.net/stats.html#answer-buttons)
  - [True Retention Table](https://docs.ankiweb.net/stats.html#true-retention-table)
- [Manual Analysis](https://docs.ankiweb.net/stats.html#manual-analysis)
...
`I` on the study screen.

![Card Info](https://docs.ankiweb.net/media/card_info.png)
...
top of the main window, or by pressing `T`.

![Statistics screen](https://docs.ankiweb.net/media/Statistics.png)
...
Daily load = 110+150=0.12, meaning that, _on average_, you will have 0.12 due cards per day.
...
[mature](https://docs.ankiweb.net/getting-started.html#card-states), young, relearning, or learning cards.
...
[mature](https://docs.ankiweb.net/getting-started.html#card-states) cards. Anki also displays the percentage
...
If you are using FSRS, your true retention is expected to be close to your [desired retention](https://docs.ankiweb.net/deck-options.html#desired-retention).
...
3. Suspend/reformulate [leeches](https://docs.ankiweb.net/leeches.html).
4. Make sure you are [using the answer buttons as intended](https://docs.ankiweb.net/studying.html#answer-buttons).
...
One option is to [write an add-on](https://docs.ankiweb.net/addons.html) that adds another graph or
